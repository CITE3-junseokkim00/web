            ...
            <div class="flex flex-col mb-10 lg:items-start items-center">
              <div class="flex-grow">
                ...
                <p class="leading-relaxed text-lg">
                  This project uses Inference API for building models
                </p>
              </div>
            </div>
            <div class="flex flex-col mb-10 lg:items-start items-center">
              <div class="flex-grow">
                <h2 class="text-white text-2xl title-font font-medium mb-3">
                  Tested by Elementary school
                </h2>
                <p class="leading-relaxed text-lg">
                  The Following project is tested with Pohang Elementary School
                </p>
              </div>
            </div>
            {/* <div class="flex flex-col mb-10 lg:items-start items-center">
